...
function SidebarIcons({ id }) {
    const icons = {
        ...
        2: (
            <>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5M12 18v-6M9 15h6"/></svg>
            </>
        ),
        3: (
            <>
...
export default function Sidebar({ onSidebarHide, showSidebar }) {
    const sidebarItems = [
        [
            ...
            { id: '1', title: 'Create', link: 'create-student' },
            { id: '3', title: 'Class', link: 'student-list' },
